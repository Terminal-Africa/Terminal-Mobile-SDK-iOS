...
class ShipmentsRemote: NetworkService {
    ...
    func createShipment<ParcelM: Codable>(request: ShipmentRequest, runCompletionOnUIThread: Bool, completion: @escaping(Result<ShipmentWithPackagingData<ParcelM>, Error>) -> Void){
    ...
    func getShipment<ParcelM: Codable>(shipmentId: String, runCompletionOnUIThread: Bool, completion: @escaping(Result<ShipmentWithPackagingData<ParcelM>, Error>) -> Void){
