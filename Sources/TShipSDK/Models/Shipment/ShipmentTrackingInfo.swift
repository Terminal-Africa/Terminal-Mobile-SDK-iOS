...
public struct ShipmentTrackingInfo: Decodable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.deliveryAddress = (try? container.decode(Address.self, forKey: .deliveryAddress)) ?? Address(addressId: "", firstName: "", lastName: "", email: "", line1: "", line2: "", phoneNumber: "", altPhoneNumber: "", state: "", zipCode: "", isResidential: true, tShopId: "", coordinates: Coordinates(lat: 0, lng: 0), alias: "", createdAt: "", updatedAt: "", country: "", city: "", isDefaultAddress: false, type: .UserAddress)
        self.pickupAddress = (try? container.decode(Address.self, forKey: .pickupAddress)) ?? Address(addressId: "", firstName: "", lastName: "", email: "", line1: "", line2: "", phoneNumber: "", altPhoneNumber: "", state: "", zipCode: "", isResidential: true, tShopId: "", coordinates: Coordinates(lat: 0, lng: 0), alias: "", createdAt: "", updatedAt: "", country: "", city: "", isDefaultAddress: false, type: .UserAddress)
