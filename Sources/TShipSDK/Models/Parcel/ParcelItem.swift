...
public struct ParcelItem: Codable, Equatable {
    ...
    /// The address id of the manufacturer's profile attached to this item.
    public var manufacturersProfile: String?

    /// Regulatory documents required for this item.
    public var regulatoryDocuments: [ItemRegulatoryDocument]?

    public init(description: String, name: String, currency: Currency, quantity: Int, value: Double, weight: Double, hsCode: String? = nil, hsCodeId: String? = nil, type: ParcelItemType, manufacturerCountry: String?, scientificName: String?, manufacturersProfile: String? = nil, regulatoryDocuments: [ItemRegulatoryDocument]? = nil) {
        ...
        self.manufacturersProfile = manufacturersProfile
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.manufacturersProfile = try? container.decode(String.self, forKey: .manufacturersProfile)
    ...
    public static func == (lhs: ParcelItem, rhs: ParcelItem) -> Bool {
        return lhs.description == rhs.description && lhs.name == rhs.name && lhs.currency == rhs.currency && lhs.quantity == rhs.quantity && lhs.value == rhs.value && lhs.weight == rhs.weight && lhs.hsCode == rhs.hsCode && lhs.hsCodeId == rhs.hsCodeId && lhs.type == rhs.type && lhs.manufacturerCountry == rhs.manufacturerCountry && lhs.scientificName == rhs.scientificName && lhs.manufacturersProfile == rhs.manufacturersProfile && lhs.regulatoryDocuments == rhs.regulatoryDocuments
    }
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case manufacturersProfile = "manufacturers_profile"
