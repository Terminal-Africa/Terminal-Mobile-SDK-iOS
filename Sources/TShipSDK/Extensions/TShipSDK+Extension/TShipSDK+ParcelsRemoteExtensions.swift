...
public extension TShipSDK {
    ...
    func createParcel<T: Codable>(_ metadataType: T.Type = EmptyMetadata.self, request: ParcelRequestWithMetadata<T>, runCompletionOnUIThread: Bool = true, completion: @escaping(Result<ParcelWithoutPackagingData<T>, Error>) -> Void){
    ...
    func getParcel(parcelId: String, runCompletionOnUIThread: Bool = true, completion: @escaping(Result<ParcelWithoutPackagingData<EmptyMetadata>, Error>) -> Void){
    ...
    func updateParcel<T: Codable>(_ metadataType: T.Type = EmptyMetadata.self, parcelId: String, request: ParcelRequestWithMetadata<T>, runCompletionOnUIThread: Bool = true, completion: @escaping(Result<ParcelWithoutPackagingData<T>, Error>) -> Void){
