...
public extension TShipSDK {
    ...
    ///   - completion: The completion handler to call with the supported countries or an error.
    ...
    ///   - runCompletionOnUIThread: Boolean indicating whether the completion handler should be run on the UI or background thread. The default value is true.
    ///   - completion: The completion handler to call with the matching states or an error.
    ...
    ///   - runCompletionOnUIThread: Boolean indicating whether the completion handler should be run on the UI or background thread. The default value is true.
    ///   - completion: The completion handler to call with the matching cities or an error.
